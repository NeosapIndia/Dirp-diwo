...
let logging =  (CONFIG.db_logging == "true") ? console.log : false;
let benchmark = (CONFIG.db_logging == "true") ? true : false;
...
databases.forEach((element) => {
    db[element] = new Sequelize(dBase[element].db_name, dBase[element].db_user, dBase[element].db_password, {
      ...
      .forEach((file) => {
        ...
        let model =dbInstance['import'](path.join(filePath, file));
